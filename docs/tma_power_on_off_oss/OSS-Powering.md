...
1. Clear all the interlocks that affect the OSS, these can be [checked here](https://ts-tma.lsst.io/docs/tma_tma-is_safety-matrix/index.html)
...
2. With the interlocks cleared, try setting the OSS to AUTO mode
   1. If it fails, read teh message, it could be that something was not reseted properly or that something was tripped again. Press reset and try again
